...
{
    /// <summary>
    /// Base class for all ApiControllers in web applications those use Hozaru system.
    /// </summary>
    public abstract class HozaruApiController : ControllerBase
    {
        /// <summary>
        ...
        //        {
        //            throw new HozaruException("Must set LocalizationSourceName before, in order to get LocalizationSource");
        //        }
        ...
        public IUnitOfWorkManager UnitOfWorkManager
        {
            get
            {
                ...
                {
                    throw new HozaruException("Must set UnitOfWorkManager before use it.");
                }
