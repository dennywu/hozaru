    ...
    render() {
        ...
        return (
            <Dropdown className="kt-header__topbar-item kt-header__topbar-item--user" drop="down" alignRight>
                <Dropdown.Toggle as={HeaderDropdownToggle} id="dropdown-toggle-user-profile" className="kt-header__topbar-wrapper">
                    <div className="kt-header__topbar-user">
                        ...
                        {showAvatar && <img alt="Pic" src="https://keenthemes.com/metronic/preview/react/demo1/media/users/300_25.jpg" />}
