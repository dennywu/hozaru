...
{
    /// <summary>
    /// Defines an authorization source to be used by <see cref="HozaruUserManager{TTenant,TRole,TUser}.LoginAsync"/> method.
    /// </summary>
        ...
        where TUser : HozaruUser<TTenant, TUser>
    {
        ...
        /// This source name is set to <see cref="HozaruUser{TTenant,TUser}.AuthenticationSource"/>
