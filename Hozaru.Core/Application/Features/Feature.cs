...
namespace Hozaru.Core.Application.Features
{
    ...
    public class Feature
    {
        ...
        public Feature CreateChildFeature(string name, string defaultValue, ILocalizableString displayName = null, ILocalizableString description = null, FeatureScopes scope = FeatureScopes.All)
        {
            var feature = new Feature(name, defaultValue, displayName, description, scope) { Parent = this };
