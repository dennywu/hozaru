...
namespace Hozaru.Core.Domain.Uow
{
    ...
    public class CallContextCurrentUnitOfWorkProvider : ICurrentUnitOfWorkProvider, ITransientDependency
    {
        ...
        private const string ContextKey = "Hozaru.UnitOfWork.Current";
        ...
        {
            var unitOfWorkKey = CallContext.GetData(ContextKey) as string;
        ...
        private static void SetCurrentUow(IUnitOfWork value, ILogger logger)
        {
            ...
            {
                throw new HozaruException("Can not set unit of work! UnitOfWorkDictionary.TryAdd returns false!");
            }
