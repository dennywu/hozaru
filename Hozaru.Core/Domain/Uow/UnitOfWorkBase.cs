...
namespace Hozaru.Core.Domain.Uow
{
    ...
    public abstract class UnitOfWorkBase : IUnitOfWork
    {
        ...
        /// <summary>
        /// Reference to current Hozaru session.
        /// </summary>
        public IHozaruSession HozaruSession { private get; set; }
        ...
        private void PreventMultipleBegin()
        {
            ...
            {
                throw new HozaruException("This unit of work has started before. Can not call Start method more than once.");
            }
        ...
        private void PreventMultipleComplete()
        {
            ...
            {
                throw new HozaruException("Complete is called before!");
            }
        ...
        private void SetFilters(List<DataFilterConfiguration> filterOverrides)
        {
            ...
            if (!HozaruSession.UserId.HasValue || HozaruSession.MultiTenancySide == MultiTenancySides.Host)
            {
                ChangeFilterIsEnabledIfNotOverrided(filterOverrides, HozaruDataFilters.MustHaveTenant, false);
            }
        }
        ...
        private DataFilterConfiguration GetFilter(string filterName)
        {
            ...
            if (filter == null)
            {
                throw new HozaruException("Unknown filter name: " + filterName + ". Be sure this filter is registered before.");
            }
